...
###############################################################################
#
# csv support is still in an early stage of development. The dataset can be
# analyzed without problems but the user API is not mature yet.
#
###############################################################################
...
# - load a generic categorical dataset from a csv file
...
# and converted to a comma delimited file (csv) file.
#
# Edit the following variable with the path to the dataset
input_file = "path_to_zika_dataset.csv";
...
zika_data = CategoricalData(settings);
...
#                                 values. It is meaningful only if the data
#                                 values are single latin characters (a-zA-Z).
#
