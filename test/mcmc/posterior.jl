...
function test_mcmc_algorithm()
  ...
  trueProbS = reshape([0.6466162109955354564405638484458904713392257690429688;
  ...
  trueProbS = reshape([0.6628554623025003644798403001914266496896743774414063;
  ...
  trueProbS = reshape([0.6487705348032424268467366346158087253570556640625000;
  ...
  trueProbS = reshape([0.6350275618390684995162587256345432251691818237304688;
